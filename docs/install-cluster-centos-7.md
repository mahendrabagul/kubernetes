...
|----|----|----|----|----|----|
|Master|kmaster.example.com|192.168.1.15|CentOS 7|2G|2|
|Worker|kworker.example.com|192.168.1.11|CentOS 7|1G|1|
...
```
cat >>/etc/hosts<<EOF
192.168.1.15 kmaster.example.com kmaster
192.168.1.11 kworker.example.com kworker
EOF
```
...
```
kubeadm init --apiserver-advertise-address=192.168.1.15 --pod-network-cidr=192.168.0.0/16
```
##### Copy kube config
